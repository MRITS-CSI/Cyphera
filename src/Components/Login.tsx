            ...
            <div className="container">
                <div className="fcontainer">
                    <form className="lcontf">
                        ...
                        <div>
                            <p className="desc">
                                Enter your team number and your password (your
                                password will have been mailed to your team
                                leader) and wait until you are told to login.
                            </p>
                        </div>
                    </form>
                </div>
                ...
                <div className="fcontainer right">
                    ...
                    <div className="rdesc">
                        <p className="rounddesc">
                            You will be given two sets of encrypted messages,
                            with examples for each set. Using the examples,
                            figure out the cipher used and decipher the
                            messages.
                        </p>
                        <p className="rounddesc">
                            You will be scored based on the time it takes you to
                            decipher and the amount of text you accurately
                            decipher.
                        </p>
                    </div>
                </div>
